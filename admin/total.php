...
<html dir="rtl">
    ...
    <body>
      <h4 class="text-center pt-3 mr-4 font-weight-bold"> تقرير إحصائي بعدد المترددين و الذين يعانون من امراض مزمنة علي مستوي الجمهورية بالمحافظات </h4>
...
function exportTableToExcel(tableID, filename = 'مبادرة الاعتلال الكلوى'){
   ...
   document.getElementById('governorate').value = "<?php echo $governorate;?>";
