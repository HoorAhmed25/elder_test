...
?>
    ...
    <select name="diabetes" id="diabetes" class="form-select w-75 form-control" onchange="blood (); Check()">
...
<p id="bmi" name="bmi" style="width:200px; height:40px; background-color:white;  border-radius: 5px; border:2px solid #FBE6C2; padding-top:8px; padding-bottom:8px; padding-right:2px; color:black;" maxlength="5"></p>
            ...
            <div class="row">
                ...
                <div class="mb-3 col-3" id="hba1cDiv"  style="display:block;">
                    ...
                    <input type="number" class="form-control w-75" name="HbA1c" id="HbA1c" autocomplete="off" min="4"  max="16" onchange="errorCheck();">
            ...
            <div class="row">
                ...
                <div class="mb-3 col-3" id="triglycaridDiv" style="display:block;" >
                    ...
                    <input type="number" class="form-control w-75" name="triglycerides" id="triglycerides" autocomplete="off" min="50"  max="5000" onkeypress="return isNumberKey(event)" onchange="errorCheck();">
                ...
                <div class="mb-3 col-3" id="hdlDiv" style="display:block;" >
                    ...
                    <input type="number" class="form-control w-75 " name="hdl" id="hdl" autocomplete="off" onkeypress="return isNumberKey(event)" min="20"  max="300" onchange="errorCheck();">
                ...
                <div id="ldlDiv" class="mb-3 col-3 " style="display:block;">
                    ...
                    <input type="number" class="form-control w-75" name="ldl" id="ldl" min="30"  max="250"  onkeypress="return isNumberKey(event)" maxlength="3" autocomplete="off" onchange="errorCheck();">
                ...
                <div id="cholesterolDiv" class="mb-3 col-3 " style="display:block;">
                    ...
                    <input type="number" class="form-control w-75" name="cholesterol" id="cholesterol" min="50" max="500"  maxlength="3" autocomplete="off" onchange="errorCheck();">
            ...
            <div class="row">
                <div class="mb-3 col-3 ">
                    <label for="hb" class="form-label"> HB
                        :</label>
                    <input type="number" class="form-control w-75" name="hb" id="p1" min="3"  max="18" onkeypress="return isNumberKey(event)" maxlength="2" autocomplete="off"  onchange="errorCheck();">
...
<p id="bmi" name="bmi" style="width:200px; height:40px; background-color:white;  border-radius: 5px; border:2px solid #FBE6C2; padding-top:8px; padding-bottom:8px; padding-right:2px; color:black;" maxlength="5"></p>
            ...
            <div class="row">
                <div class="mb-3 col-3" id="xrayDiv"  style="display:block;">
                    <label for="xray" class="form-label">الموجات فوق صوتيه علي البطن :</label>
                    <select name="xray" id="p9" class="form-select w-75 form-control" onchange="message(); checkGender();">
                        <option value=" ">--اختر--</option>
                        <option value="نعم" >طبيعي</option>
                        <option value="لا">غير طبيعي</option>
<option value="لم يتم">لم يتم </option>
...
var bmi = weight / (height*height);
  ...
  if(diastolic < 30 || diastolic > 150 || systolic < 60 || systolic > 260){
   ...
   if(weight < 40 || weight > 250){
     ...
     if(hba1c < 4 || hba1c > 16){
         document.getElementById("hba1cError").innerHTML =  "* من فضلك ادخل قيمة صحيحة";
     }  
    else {
        document.getElementById("hba1cError").innerHTML =  " ";
    }
